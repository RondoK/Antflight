...
namespace AntFlight.Migrations
{
    ...
    [Migration("20170412185329_Flight Description string to byte")]
    partial class FlightDescriptionstringtobyte
    {
            ...
            modelBuilder.Entity("AntFlight.Models.FlightMessages.FlightMessageDiscription", b =>
                {
                    b.HasOne("AntFlight.Models.FlightMessages.FlightMessage", "FlightMessage")
                        ...
                        .HasForeignKey("AntFlight.Models.FlightMessages.FlightMessageDiscription", "FlightMessageId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
